...
def process_github_link(app,link):
    ...
    try:
        ...
        if not skip:
            ...
            os.environ["MAVEN_OPTS"] = f"-javaagent:/home/robin489/vuln2/PackagePermissionsManager/target/PackagePermissionsManager-1.0-SNAPSHOT-perm-agent.jar=m10,{app}/packagePerms/{repo_name}"
            ...
            os.environ["MAVEN_OPTS"] = f"-javaagent:/home/robin489/vuln2/PackagePermissionsManager/target/PackagePermissionsManager-1.0-SNAPSHOT-perm-agent.jar=m10,{app}/packagePerms/{repo_name}Control"
